...
(function($, CUI) {
    ...
    CUI.rte.ui.cui.ContentSummarizationDialog = new Class({

        extend: CUI.rte.ui.cui.AbstractBaseDialog,

        toString: "ContentSummarizationDialog",
    ...
    requestContentSummary: function (prompt) {
        let contentSummary = "";
    ...
    getSummaryRequest: function (requestFn) {
        let summary="";
    ...
    onShow: function() {
            ...
            this.getSummaryRequest(this.requestContentSummary);
